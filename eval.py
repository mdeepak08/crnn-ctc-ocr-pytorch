...
def main() -> None:
    ...
    mcfg = CRNNConfig(
        ...
        cnn_backbone=str(cfg["model"].get("cnn_backbone", "simple")),
        resnet_base_channels=int(cfg["model"].get("resnet_base_channels", 64)),
        resnet_layers=tuple(cfg["model"].get("resnet_layers", [2, 2, 2])),
